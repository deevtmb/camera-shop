# Проект Camera shop (1я итерация)

## Структура проекта

### markup

Директория с исходной разметкой и статичными данными (стили, шрифты, изображения).
...
Директория для размещения статичных ресурсов (шрифты, стили, изображения). Корневая директория проекта.
